...
export default function BrandHeroSection({ brand, brands = [], models = [], brandId, backendBrand, newsSlot }: BrandHeroSectionProps) {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Car Expert Banner - After Alternative Brands */}
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4">
        <CarExpertBanner
          title={`Confused which ${brand.name} car to choose?`}
          subtitle={`Our experts help you pick the perfect ${brand.name} model for your needs & budget`}
          feature1="Best Deals"
          feature2="Price Help"
          feature3="Model Compare"
        />
      </div>
