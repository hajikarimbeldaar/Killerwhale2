            ...
            <div id="summary" className="space-y-6">
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                <div className="p-6 sm:p-8">
                  ...
                  {/* Dynamic Localized SEO Content to break thin-content penalty */}
                  {modelVariants.length > 0 && (
                    <CitySEOContent
                      ...
                      transmissions={[...new Set(modelVariants.map(v => v.transmission).filter(Boolean))]}
                      fuelTypes={[...new Set(modelVariants.map(v => v.fuel).filter(Boolean))]}
                    />
                  )}
                </div>
              </div>
