...
async function getTransCarsData(type: string) {
    ...
    try {
        ...
        return { cars: cars.slice(0, 12), popularCars, newLaunchedCars, dynamicDescription }
    } catch (error) {
        ...
        <div className="min-h-screen bg-gray-50">
            <main>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <CarExpertBanner
                        title={`Need help finding the best ${transLabel} car?`}
                        subtitle="Our experts help you pick the perfect car for your budget & needs"
                        feature1="Best Control"
                        feature2="Price Help"
                        feature3="Expert Guide"
                    />
                </div>
