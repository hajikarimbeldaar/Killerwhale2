...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.gadizone.com/logo.png?v=1.0.1',
        width: 512,
        height: 512,
        alt: 'gadizone Logo',
      },
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Preconnect to backend API — critical for SSR data fetching and image loading */}
        {process.env.NEXT_PUBLIC_API_URL && (
          <link rel="preconnect" href={new URL(process.env.NEXT_PUBLIC_API_URL).origin} />
        )}
        {process.env.NEXT_PUBLIC_BACKEND_URL && (
          <link rel="preconnect" href={new URL(process.env.NEXT_PUBLIC_BACKEND_URL).origin} crossOrigin="anonymous" />
        )}
